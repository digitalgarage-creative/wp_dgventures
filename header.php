					  ...
					  <div class="collapse navbar-collapse" id="nav-dgv">
					    <ul class="navbar-nav ml-auto">
					      <li class="nav-item active">
					        <a class="nav-link" href="<?php echo pll_home_url(); ?>about/">About</a>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link" href="<?php echo pll_home_url(); ?>strategy/">Strategy</a>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link" href="<?php echo pll_home_url(); ?>team/">Team</a>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link" href="<?php echo pll_home_url(); ?>portfolio/">Portfolio</a>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link" href="<?php echo pll_home_url(); ?>interview/">Interview</a>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link" href="<?php echo pll_home_url(); ?>news/">News</a>
					      </li>
						 ...
						 <a class="nav-link pr-0 disabled" href="">JA</a> / <a class="nav-link pl-0" href="<?php icl_post_languages_link(); ?>">EN</a>
						
						<?php } elseif(ICL_LANGUAGE_CODE == 'en'){ ?>
							 <a class="nav-link pr-0 " href="<?php icl_post_languages_link(); ?>">JA</a> / <a class="nav-link pl-0 disabled" href="">EN</a>
